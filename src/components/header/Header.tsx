      ...
      <div className="header-content">
        <div className="brand-section">
          ...
          <div className="brand-text">
            <h1 className="brand-title">Velocity</h1>
            <p className="brand-motto">Move forward with purpose</p>
          </div>
        </div>
